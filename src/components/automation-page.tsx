        ...
        <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-medium text-gray-900 mb-2">1. Login</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-medium text-gray-900 mb-2">2. Navigate</h3>
              <p className="text-sm text-gray-600">
                Navigates to the network growth section and opens connection
                modal
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-medium text-gray-900 mb-2">3. Connect</h3>
              <p className="text-sm text-gray-600">
